...
import $ from 'jquery';
import img from '../../images/News/Rectangle 43 (1).png';
    ...
    <>
      ...
      <header className="top-wave">
          <div className="container h-100 d-flex justify-content-center align-items-center text-center flex-column">
              <h2 className='mb-3 text-white h1 wow fadeInDownBig text-capitalize' style={{fontWeight: '600'}} data-wow-duration="1s" data-wow-delay="0.5s">{isEng ? 'News Title' : 'عنـوان الخبــر'}</h2>
          ...
          <div className="container">
              <div className="row justify-content-center align-items-center flex-column">
                  <div className="col-lg-12 col-11">
                      <div className="img-news mb-3">
                          <img src={img} className='w-100 wow fadeInDown' data-wow-duration="1s" data-wow-delay="0.5s" style={{minHeight: '300px' , maxHeight: '500px'}} alt="img-news" />
                      </div>
                      <div className="row gy-3 gx-0 d-flex justify-content-md-between align-items-center">
                          <div className="col-md-6">
                              <div className="name-blog-author wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                                  <h4 className='fw-bold mb-2'>{isEng ? 'News Title Here' : 'عنوان الخبــر هنـا'}</h4>
